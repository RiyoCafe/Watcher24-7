package com.example.watcher.helper;
...
import com.example.watcher.MessageActivity;
...
public class DeviceLocationFinder {
    public static DeviceLocationFinder instance;
    ...
    public static void getCurrentDeviceLocation(Context context, OnDeviceLocationFoundListener listener){
            ...
            public void onLocationResult(LocationResult locationResult) {
                ...
                if (locationResult != null && locationResult.getLocations().size() > 0) {
                   ...
                   Double longitude = locationResult.getLocations().get(latestLocationIndex).getLongitude();
                    Log.d(TAG, "onLocationResult: device location lati :"+latitude+" long : "+longitude);
                    if (listener!=null)
                    {
                        listener.onDeviceLocationFound(new LatLng(latitude,longitude));
                    }
                }else
                {
                    Log.d(TAG, "onLocationResult: device location not  found");
                }
            }
        };
